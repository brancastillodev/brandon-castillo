  ...
  return(
    <div className="exp-card">
      ...
      <div className="exp-card__title">
        <a className="exp-card__link" href={exp.web} target="_blank" rel="noopener noreferrer">
          <h4 className="exp-card__title__text">{exp.title}</h4>
      ...
      {/* extra */}
      {exp.extra && (
        <div className="exp-card__extra-wrap">
          {exp.extra.map((ele: { link: string; name: string }, i: number)=>(
